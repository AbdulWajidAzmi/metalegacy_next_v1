    ...
    <section className=" banner">
      ...
      <div className="container">
        <h1 className="heading">
          <span>
            <span className={!rightColored && "colored"}>{heading[0]} </span>
            <span className={rightColored && "colored"}>{heading[1]}</span>
          </span>
        </h1>
        <h4 className="mb1  mt1">
          <span>
            {subHeading[0]} <span className="colored"> {subHeading[1]} </span>{" "}
            {subHeading[2]} <span className="colored"> {subHeading[3]} </span>
          </span>
        </h4>
        <div className="banner_btns">
          ...
          <Link href="/contact-us/#contact_form_section">
            <a>
